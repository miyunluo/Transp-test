...
class MultiLayerPerceptronBackend(BaseBackend):
    ...
    def _create_mlp_trainer(self, params):
        ...
        #def categorical_crossentropy_modify(coding_dist, true_dist):
        #    print("--------dimension of inner sum:---------", (true_dist     ).shape )
        #    return -tensor.sum(true_dist * tensor.log(coding_dist),axis=coding_dist.ndim - 1)
        #self.cost_function = categorical_crossentropy_modify
        ...
        #print("----------cost_function:----------- ", self.cost_function)
        #print("----------cost_symbol:------------- ", cost_symbol)
        #print("----------data_mask:--------------- ", self.data_mask)
    ...
    def _create_trainer_function(self, params, cost):
        ...
        #print("----------learning_rule:----------- ", self.learning_rule)
    ...
    def _batch_impl(self, X, y, w, processor, mode, output, shuffle):
        #_batch_impl(     X, y, w, self.trainer, mode='train', output='.', shuffle=True)
